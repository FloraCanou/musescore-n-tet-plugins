...
MuseScore {
      version:  "1.3.5"
      description: "Retune selection to 19-TET, or whole score if nothing selected."
      menuPath: "Plugins.Notes.Retune 19-TET"

      // WARNING! This doesn't validate the accidental code!
      property variant customKeySigRegex: /\.(.*)\.(.*)\.(.*)\.(.*)\.(.*)\.(.*)\.(.*)/g
      property var stepSize: 1200.0/19
      property variant centOffsets: {
        'a': {
          '-4': stepSize * -10 + 500 + 200, // Abb
          '-2': stepSize * -9 + 500 + 100,  // Ab
           0: stepSize * -8 + 500,          // A
           2: stepSize * -7 + 500 - 100,    // A#
           4: stepSize * -6 + 500 - 200     // Ax
        },
        'b': {
          '-4': stepSize * -7 + 300 + 200,
          '-2': stepSize * -6 + 300 + 100,
           0: stepSize * -5 + 300,
           2: stepSize * -4 + 300 - 100,
           4: stepSize * -3 + 300 - 200
        },
        'c': {
          '-4': stepSize * -5 + 200 + 200,
          '-2': stepSize * -4 + 200 + 100,
           0: stepSize * -3 + 200,
           2: stepSize * -2 + 200 - 100,
           4: stepSize * -1 + 200 - 200
        },
        'd': {
          '-4': stepSize * -2 + 200,
          '-2': stepSize * -1 + 100,
        ...
        'g': {
          '-4': stepSize * 6 - 500 + 200,
          '-2': stepSize * 7 - 500 + 100,
           0: stepSize * 8 - 500,
           2: stepSize * 9 - 500 - 100,
           4: stepSize * 10 - 500 - 200
        }
      }
      ...
      //
      // For example, this is Fb major: .b.b.b.b.b.b.bb
      //
