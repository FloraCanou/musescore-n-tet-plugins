...
MuseScore {
      version:  "1.3.5"
      description: "Retune selection to 34-TET, or whole score if nothing selected."
      menuPath: "Plugins.Notes.Retune 34-TET"

      // WARNING! This doesn't validate the accidental code!
      property variant customKeySigRegex: /\.(.*)\.(.*)\.(.*)\.(.*)\.(.*)\.(.*)\.(.*)/g
      property var stepSize: 1200.0/34
      property variant centOffsets: {
        'a': {
          //'-9': stepSize * -23 + 500,        //Abbv
          '-8': stepSize * -22 + 500 + 200,  //Abb
          '-7': stepSize * -21 + 500,        //Abb^
          '-6': stepSize * -20 + 500,        //Adb
          '-5': stepSize * -19 + 500,        //Abv
          '-4': stepSize * -18 + 500 + 100,  //Ab
          '-3': stepSize * -17 + 500,        //Ab^
          '-2': stepSize * -16 + 500,        //Ad
          '-1': stepSize * -15 + 500,        //Av
           0: stepSize * -14 + 500,          //A
           1: stepSize * -13 + 500,          //A^
           2: stepSize * -12 + 500,          //A+
           3: stepSize * -11 + 500,          //A#v
           4: stepSize * -10 + 500 - 100,    //A#
           5: stepSize * -9 + 500,           //A#^
           6: stepSize * -8 + 500,           //A+#
           7: stepSize * -7 + 500,           //Axv
           8: stepSize * -6 + 500 - 200,     //Ax
           //9: stepSize * -5 + 500,           //Ax^
        },
        'b': {
          //'-9': stepSize * -17 + 300,
          '-8': stepSize * -16 + 300 + 200,
          '-7': stepSize * -15 + 300,
          '-6': stepSize * -14 + 300,
          '-5': stepSize * -13 + 300,
          '-4': stepSize * -12 + 300 + 100,
          '-3': stepSize * -11 + 300,
          '-2': stepSize * -10 + 300,
          '-1': stepSize * -9 + 300,
           0: stepSize * -8 + 300,
           ...
           2: stepSize * -6 + 300,
           3: stepSize * -5 + 300,
           4: stepSize * -4 + 300 - 100,
           5: stepSize * -3 + 300,
           6: stepSize * -2 + 300,
           7: stepSize * -1 + 300,
           8: stepSize * 0 + 300 - 200,
           //9: stepSize * 1 + 300,
        },
        'c': {
          //'-9': stepSize * -15 + 200,
          '-8': stepSize * -14 + 200 + 200,
          '-7': stepSize * -13 + 200,
          '-6': stepSize * -12 + 200,
          '-5': stepSize * -11 + 200,
          '-4': stepSize * -10 + 200 + 100,
          '-3': stepSize * -9 + 200,
          '-2': stepSize * -8 + 200,
          '-1': stepSize * -7 + 200,
           0: stepSize * -6 + 200,
           ...
           2: stepSize * -4 + 200,
           3: stepSize * -3 + 200,
           4: stepSize * -2 + 200 - 100,
           5: stepSize * -1 + 200,
           6: stepSize * 0 + 200,
           7: stepSize * 1 + 200,
           8: stepSize * 2 + 200 - 200,
           //9: stepSize * 3 + 200,
        },
        'd': {
          //'-9': stepSize * -9,
        ...
        'g': {
          //'-9': stepSize * 5 - 500,
          '-8': stepSize * 6 - 500 + 200,
          '-7': stepSize * 7 - 500,
          '-6': stepSize * 8 - 500,
          '-5': stepSize * 9 - 500,
          '-4': stepSize * 10 - 500 + 100,
          '-3': stepSize * 11 - 500,
          '-2': stepSize * 12 - 500,
          '-1': stepSize * 13 - 500,
           0: stepSize * 14 - 500,
           ...
           2: stepSize * 16 - 500,
           3: stepSize * 17 - 500,
           4: stepSize * 18 - 500 - 100,
           5: stepSize * 19 - 500,
           6: stepSize * 20 - 500,
           7: stepSize * 21 - 500,
           8: stepSize * 22 - 500 - 200,
           //9: stepSize * 23 - 500,
        }
      }
